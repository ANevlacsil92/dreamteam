...
export declare function _clone_children_references(node: BaseNode, newParent: BaseNode, copyAlsoModellingRules: boolean, optionalFilter?: CloneFilter, extraInfo?: CloneExtraInfo): void;
export declare function _clone_non_hierarchical_references(node: BaseNode, newParent: BaseNode, copyAlsoModellingRules: boolean, optionalFilter?: CloneFilter, extraInfo?: CloneExtraInfo): void;
/**
 * @method _clone
 * @private
 */
