...
function topMostParentIsObjectTypeOrVariableType(addressSpace, options) {
    ...
    while (currentNode) {
        ...
        currentNode = (_a = currentNode.findReferencesEx("HasChild", node_opcua_data_model_2.BrowseDirection.Inverse)[0]) === null || _a === void 0 ? void 0 : _a.node;
    }
    return false;
}
...
class UAVariableTypeImpl extends base_node_impl_1.BaseNodeImpl {
    constructor(options) {
        ...
        (0, ua_variable_impl_1.verifyRankAndDimensions)(options);
...
//
function _initialize_properties_and_components(instance, topMostType, typeNode, copyAlsoModellingRules, optionalsMap, extraInfo) {
    if (doDebug) {
    ...
    if ((0, node_opcua_nodeid_1.sameNodeId)(topMostType.nodeId, typeNode.nodeId)) {
    ...
    (0, base_node_private_1._clone_children_references)(typeNode, instance, copyAlsoModellingRules, filter, extraInfo);
