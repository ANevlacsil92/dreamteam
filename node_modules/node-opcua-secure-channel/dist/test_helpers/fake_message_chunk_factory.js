...
function iterateOnSymmetricEncryptedChunk(buffer, callback) {
    ...
    options.signBufferFunc = (chunk) => (0, node_opcua_crypto_1.makeMessageChunkSignatureWithDerivedKeys)(chunk, exports.derivedKeys);
    ...
    options.encryptBufferFunc = (chunk) => (0, node_opcua_crypto_1.encryptBufferWithDerivedKeys)(chunk, exports.derivedKeys);
